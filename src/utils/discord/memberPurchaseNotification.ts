...
export async function notifyMemberPurchaseDeposit(
  ...
  try {
    ...
    const embed: DiscordEmbed = {
      title: '📦 Member Safe Purchase Deposit',
      description: `Items added to member safe from purchase`,
    ...
    console.error('Failed to send member purchase Discord notification:', error instanceof Error ? error.message : 'Unknown error');
    throw error;
  }
}
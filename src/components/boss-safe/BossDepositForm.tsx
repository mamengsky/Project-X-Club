...
import { useBossDepositForm } from '../../hooks/useBossDepositForm';
import MemberSelect from '../deposit/MemberSelect';
import { ClubMember } from '../../types/member';

export default function BossDepositForm() {
  const { formData, setFormData, error, isSubmitting, handleSubmit } = useBossDepositForm();
